          ...
          {options.map((option, index) => {
            return (
              <ListBoxItem
                key={index}
                id={option}
                className="pl-3 pr-5 py-1 focus:bg-neutral-100 dark:focus:bg-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-700 selected:bg-lime-200 dark:selected:bg-lime-700"
              >
                {option}
              </ListBoxItem>
            );
